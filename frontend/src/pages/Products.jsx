...
{/* Product Image */}
      <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
        <div clasName='flex sm:flex-col overflow-x-auto sm:overflow-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
          {
...
<div clasName='flex-1'>
  ...
  <p className='mt-5 text-3xl font-medium'>{currency}{productData.price}
  </p>
